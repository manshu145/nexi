...
export function getFirebaseAuth(env: Env): Auth { return getAuth(getOrInitApp(env)); }
export function getFirebaseFirestore(env: Env): Firestore { return getFirestore(getOrInitApp(env)); }
