...
/**
 * Auth principal attached to the context after verifying Firebase ID token.
 */
...
/**
 * Creates the auth middleware that verifies Firebase ID tokens.
 */
...
/**
 * Retrieve the authenticated principal from context. Throws 401 if not present.
 */
