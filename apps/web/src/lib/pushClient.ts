 ...
 *
 * PR-48: VAPID key is now fetched from the /v1/branding endpoint at runtime
 * (which reads it from admin panel → Service Keys → FCM). No build-time
 * env var needed — admin pastes the key in /admin/service-keys, done.
 *
