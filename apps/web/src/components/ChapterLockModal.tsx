...
interface ChapterLockModalProps {
  credits: number;
  onUseCredits: () => void;
  loading?: boolean;
}
...
/**
 * Chapter paywall for Free-plan users. Reading a new chapter costs credits;
 * this modal lets the user spend credits to unlock OR upgrade. Kept as a
 * dedicated component (separate from the generic feature-aware <PlanGate/>)
 * because it offers the credit-spend path the generic upgrade prompt doesn't.
 */
export function ChapterLockModal({ credits, onUseCredits, loading }: ChapterLockModalProps) {
