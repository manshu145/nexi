  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-lg flex-col px-5 pt-6 pb-28">
      ...
      <section className="mt-8 grid gap-3 sm:grid-cols-3">
        <button type="button" onClick={() => router.push('/study')} className="paper-card card-selectable p-5 text-left"><span className="text-2xl">📖</span><h3 className="mt-2 font-serif font-semibold text-ink-900">{t('study')}</h3><p className="mt-1 text-xs text-muted-500">{t('studyDesc')}</p></button>
        <button type="button" onClick={() => router.push('/current-affairs')} className="paper-card card-selectable p-5 text-left"><span className="text-2xl">📰</span><h3 className="mt-2 font-serif font-semibold text-ink-900">{t('currentAffairs')}</h3><p className="mt-1 text-xs text-muted-500">{t('currentAffairsDesc')}</p></button>
        <button type="button" onClick={() => router.push('/nexi')} className="paper-card card-selectable p-5 text-left"><span className="text-2xl">🤖</span><h3 className="mt-2 font-serif font-semibold text-ink-900">{t('nexiAI')}</h3><p className="mt-1 text-xs text-muted-500">{t('nexiAIDesc')}</p></button>
        <button type="button" onClick={() => router.push('/chat')} className="paper-card card-selectable p-5 text-left"><span className="text-2xl">💬</span><h3 className="mt-2 font-serif font-semibold text-ink-900">Nexi Chat</h3><p className="mt-1 text-xs text-muted-500">AI-powered conversation for doubts</p></button>
        <button type="button" onClick={() => router.push('/upgrade')} className="paper-card card-selectable p-5 text-left"><span className="text-2xl">⭐</span><h3 className="mt-2 font-serif font-semibold text-ink-900">Upgrade</h3><p className="mt-1 text-xs text-muted-500">Unlock premium features</p></button>
        <button type="button" onClick={() => router.push('/support')} className="paper-card card-selectable p-5 text-left"><span className="text-2xl">🛟</span><h3 className="mt-2 font-serif font-semibold text-ink-900">Support</h3><p className="mt-1 text-xs text-muted-500">Get help with any issues</p></button>
      </section>
