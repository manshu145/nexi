...
export default function DashboardPage() {
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-lg flex-col px-5 pt-6 pb-28">
      ...
      <section className="mt-6"><p className="text-sm text-muted-500">{greeting}, <span className="font-semibold text-ink-900 dark:text-paper-50">{firstName}</span></p><h1 className="font-serif mt-1 text-2xl font-bold text-ink-900 dark:text-paper-50">{examName}</h1></section>
