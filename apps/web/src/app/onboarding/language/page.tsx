    ...
    <div className="flex flex-col items-center">
      ...
      <div className="mt-8 grid w-full gap-4 sm:grid-cols-2">
        <button
          ...
          disabled={saving}
          className="card cursor-pointer p-8 text-center transition-all hover:border-amber-500 hover:ring-2 hover:ring-amber-500/20 active:scale-[0.98]"
        >
