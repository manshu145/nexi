  ...
  return (
    <div className="max-w-3xl">
      ...
      <section className="paper-card mt-4 p-5">
        ...
        <p className="text-xs text-muted-500 mt-1">AdSense, Search Console, and other external platform verification codes</p>
        <div className="mt-4 space-y-4">
          <div>
            <label className="text-xs font-medium text-ink-700">ads.txt Content</label>
            <p className="text-[10px] text-muted-400 mt-0.5 mb-1">
              Paste your AdSense ads.txt entry here. Served at <code className="rounded bg-paper-200 px-1">nexigrate.com/ads.txt</code> and <code className="rounded bg-paper-200 px-1">api.nexigrate.com/ads.txt</code>.
            </p>
            <textarea
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-400 mt-0.5 mb-1">
              Paste raw HTML meta tags or scripts for the &lt;head&gt;. AdSense auto-ads, Search Console verification, Facebook Pixel, etc.
            </p>
            <textarea
            ...
            />
            <p className="text-[10px] text-muted-400 mt-1">Each line = one complete HTML tag. Injected as-is into &lt;head&gt; on both sites.</p>
          </div>
        </div>
      </section>
